...
let own = {
owner: '*ᴏɴʟʏ ᴏᴡɴᴇʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴏᴡɴᴇʀ ʏᴀᴇᴍɪᴋᴏ-ʙᴏᴛᴢ'}[type]
...
let mod = {
mods: '*ᴏɴʟʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴍᴏᴅᴇʀᴀᴛᴏʀ *YAE* ʙᴏᴛ'}[type]
...
let prm = {
        premium: '*ᴏɴʟʏ ᴘʀᴇᴍɪᴜᴍ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴜꜱᴇʀ ᴘʀᴇᴍɪᴜᴍ ʏᴀᴇ-ʙᴏᴛᴢ'}[type]
...
if (msgg) return conn.sendButtonDocAccess(m.chat, `${ucapan()} ` + tag, msgg + '\n\n\n\n', 'Daftar Yae-Botz', '.verify', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/lans.xys',
    mediaType: 2, 
    description: sgc,
    title: "Yae Miko-Botz",
