 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".h1 infobot", description: "✧ Info nya AMELIA BOT ><"},
	    {title: `💌)ഒ Owner`, rowId: ".h1 owner", description: "✧ Ini Room Developer ku ^~^"},
	{title: `🗣)ഒ Request Fitur`, rowId: ".h1 request", description: "✧ Request Fitur menarik ke BOT"},
	{title: `💻)ഒ Bot Stats`, rowId: ".h1 botinfo", description: "✧ Menampilkan Status 赤 AMELIA - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".h1 testspeed", description: "✧ Test Install Speed BOT"},
	{title: `🔧)ഒ Customer Service`, rowId: ".h1 complaint", description: "✧ Report keluhan mu di sini..."},
	{title: `⚡)ഒ Speed`, rowId: ".h1 speed", description: "✧ Kecepatan Respon 赤 AMELIA - BOT..."},
	]
    },{
	...
	rows: [
	    ...
	    {title: `🌟 〉ɞ 『 UP Premium 』`, rowId: ".uppremium", description: "✧ Menampilkan list harga upgrade premium"},
	...
	rows: [
	    {title: `⫹🗒️ › 𐐪-〚 All Menu 〛-𐑂`, rowId: ".h1 all", description: "╰► Waduhh. Langsung semuanya (≧▽≦)"},
	    {title: `⫹🌱 › 𐐪-〚 Rpg 〛-𐑂`, rowId: ".h1 rpg", description: "╰► Calon anak petualang nih... -𐑂"},
	{title: `⫹✨ › 𐐪-〚 Exp 〛-𐑂`, rowId: ".h1 xp", description: "╰► Kalau dah level 100 dapat hadiah (≧▽≦)"},
	{title: `⫹🎮 › 𐐪-〚 Game 〛-𐑂`, rowId: ".h1 game", description: "╰► Bg kamu main game apa?.... >-<"},
	{title: `⫹🧩 › 𐐪-〚 Fun 〛-𐑂`, rowId: ".h1 fun", description: "╰► Gabut ya bang?"},
	{title: `⫹🐚 › 𐐪-〚 Kerang 〛-𐑂`, rowId: ".h1 kerangajaib", description: "╰► Mau tanya apa sih bg?..."},
	{title: `⫹📑 › 𐐪-〚 Quotes 〛-𐑂`, rowId: ".h1 quotes", description: "╰► Ada yg mau nyari topik nih... >-<"},
	{title: `⫹⛩️ › 𐐪-〚 Anime 〛-𐑂`, rowId: ".h1 anime", description: "╰► Lah, Wibuu...-𐑂"},
	{title: `⫹🍭 › 𐐪-〚 Thanks To 〛-𐑂`, rowId: ".h1 tqto", description: "╰► Contributor Amelia BOT -𐑂"},
	{title: `⫹🔞 › 𐐪-〚 Nsfw 〛-𐑂`, rowId: ".h1 nsfw", description: "╰► Anak kecil ga boleh ya...."},
	{title: `⫹🌟 › 𐐪-〚 Premium 〛-𐑂`, rowId: ".h1 premium", description: "╰► Hanya khusus users premium..."},
	{title: `⫹🎭 › 𐐪-〚 Anonymous chat 〛-𐑂`, rowId: ".h1 anonymous", description: "╰► Mau ngomong sama mantan kah? >.<"},
	{title: `⫹☪️ › 𐐪-〚 Islamic 〛-𐑂`, rowId: ".h1 quran", description: "╰► Tibat ya kak..."},
	{title: `⫹🌐 › 𐐪-〚 Internet 〛-𐑂`, rowId: ".h1 internet", description: "╰► Ga ada google ya kak..."},
	{title: `⫹📤️ › 𐐪-〚 Downloader 〛-𐑂`, rowId: ".h1 downloader", description: "╰► Jangan download yg aneh-aneh, Xixixi (≧▽≦)"},
	{title: `⫹🃏 › 𐐪-〚 Stikers 〛-𐑂`, rowId: ".h1 stiker", description: "╰► Kalau bikin sticker jangan di spam ya kak..."},
	{title: `⫹✏️ › 𐐪-〚 Nulis 〛-𐑂`, rowId: ".h1 nulis", description: "╰► Hati-hati ke tawan bu sri..."},
	{title: `⫹🎵 › 𐐪-〚 Audio 〛-𐑂`, rowId: ".h1 audio", description: "╰► Calon remixer nih haha ></"},
	{title: `⫹🦄 › 𐐪-〚 Group 〛-𐑂`, rowId: ".h1 group", description: "╰► Menu settingan buat group mu kak -𐑂"},
	{title: `⫹👑 › 𐐪-〚 Admin 〛-𐑂`, rowId: ".h1 admin", description: "╰► Yg bukan admin jangan make fitur ini >-<"},
	{title: `⫹🗃️️ › 𐐪-〚 Database 〛-𐑂`, rowId: ".h1 database", description: "╰► Simpen apa tuh.... >.<"},
	{title: `⫹🧰️ › 𐐪-〚 Tools 〛-𐑂`, rowId: ".h1 tools", description: "╰► Butuh apa aja bot akan bantu -𐑂"},
	{title: `️️⫹📊️ › 𐐪-〚 Info 〛-𐑂`, rowId: ".h1 info", description: "╰► Info lowker kak?..."},
	{title: `⫹👩‍💻 › 𐐪-〚 Owner 〛-𐑂`, rowId: ".h1 owner", description: "╰► Yg bukan developer gausah nge klik fitur ini !"},
	{title: `⫹🎨 › 𐐪-〚 Maker 〛-𐑂`, rowId: ".h1 maker", description: "╰► Bikin logo apa ya enaknya?"},
	{title: `⫹💌 › 𐐪-〚 Store 〛-𐑂`, rowId: ".h1 store", description: "╰► Anak jebeh ya kamu kak?"},
	{title: `⫹🔥 › 𐐪-〚 Virtex 〛-𐑂`, rowId: ".h1 virus", description: "╰► Jangan kak bahaya -𐑂"},
	]
    },{
...
const listMessage = {
  text: tek,
  footer: '赤 AMELIA MD RPG BOT WHATSAPP',
